...
function Species() {
    ...
    this.loadSpecies = function (res, user_id) {
        ...
        connection.acquire(function (err, con) {
            ...
            if(user_id !== 0){
                con.query(`select s.id as id, s.type as type ,SUBSTRING(s.location,1,20) as location, s.name as name,s.anonymous as anonymous,SUBSTRING(s.specname,1,42) as specname, `+
